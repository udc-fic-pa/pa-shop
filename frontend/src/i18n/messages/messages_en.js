export default {
    ...
    'project.projects.AddProject.success': 'Project "{projectName}" created successfully',
    'project.projects.AddProject.title': 'Add project',
    'project.projects.Project.NameEditor.title': 'Edit project name',
    'project.projects.Project.removeConfirmDialog.bodyTitle': 'Remove project?',
    'project.projects.Project.removeConfirmDialog.headerTitle': 'Confirm Remove',

    'project.projects.Projects.title': 'Projects',
    'project.projects.ProjectDetails.title': 'Project details',

    'project.tasks.AddTask.placeHolder': 'New task',
    'project.tasks.Task.NameEditor.title': 'Edit task name',
