export default {
    ...
    'project.projects.AddProject.success': 'Proyecto "{projectName}" creado',
    'project.projects.AddProject.title': 'Crear proyecto',
    'project.projects.Project.NameEditor.title': 'Editar nombre de proyecto',
    'project.projects.Project.removeConfirmDialog.bodyTitle': 'Eliminar proyecto?',
    'project.projects.Project.removeConfirmDialog.headerTitle': 'Confirmar borrado',

    'project.projects.Projects.title': 'Proyectos',
    'project.projects.ProjectDetails.title': 'Detalles del proyecto',

    'project.tasks.AddTask.placeHolder': 'Añadir tarea',
    'project.tasks.Task.NameEditor.title': 'Editar nombre de tarea',
