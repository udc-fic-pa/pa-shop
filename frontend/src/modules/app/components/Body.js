...
import {ProjectDetails, AddProject} from '../../projects';
...
const Body = ({user}) => (
    ...
    <div className="container">
        ...
        <Switch>
            ...
            {user && <Route exact path="/projects/project-details/:id" component={ProjectDetails}/>}
            {user && <Route exact path="/projects/add-project" component={AddProject}/>}
