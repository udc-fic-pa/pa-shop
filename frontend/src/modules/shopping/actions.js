...
export const previousFindOrdersResultPage = criteria => dispatch => {
    dispatch(clearOrderSearch());
    dispatch(findOrders({page: criteria.page-1}));
}

export const nextFindOrdersResultPage = criteria => dispatch => {
    dispatch(clearOrderSearch());
    dispatch(findOrders({page: criteria.page+1}));
}
