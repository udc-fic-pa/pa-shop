...
import static es.udc.taskmgr.backend.rest.dtos.UserConversor.toAuthenticatedUserDto;
import static es.udc.taskmgr.backend.rest.dtos.UserConversor.toUser;
import static es.udc.taskmgr.backend.rest.dtos.UserConversor.toUserDto;
...
import es.udc.taskmgr.backend.model.services.IncorrectLoginException;
import es.udc.taskmgr.backend.model.services.IncorrectPasswordException;
import es.udc.taskmgr.backend.model.services.PermissionException;
import es.udc.taskmgr.backend.model.services.UserService;
import es.udc.taskmgr.backend.rest.common.ErrorsDto;
import es.udc.taskmgr.backend.rest.common.JwtGenerator;
import es.udc.taskmgr.backend.rest.common.JwtInfo;
import es.udc.taskmgr.backend.rest.dtos.AuthenticatedUserDto;
import es.udc.taskmgr.backend.rest.dtos.UserDto;
...
public class UserController {
	...
	private String generateServiceToken(User user) {
		...
		JwtInfo jwtInfo = new JwtInfo(user.getId(), user.getFirstName(), user.getRole().toString());
