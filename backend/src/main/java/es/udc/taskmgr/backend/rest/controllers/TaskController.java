...
import static es.udc.taskmgr.backend.rest.dtos.TaskConversor.toTask;
import static es.udc.taskmgr.backend.rest.dtos.TaskConversor.toTaskDto;
import static es.udc.taskmgr.backend.rest.dtos.TaskConversor.toTaskDtos;
...
import es.udc.taskmgr.backend.model.services.TaskService;
import es.udc.taskmgr.backend.rest.dtos.TaskDto;
