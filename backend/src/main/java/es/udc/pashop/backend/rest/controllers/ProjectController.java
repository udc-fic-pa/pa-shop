...
import static es.udc.pashop.backend.rest.dtos.ProjectConversor.toProject;
import static es.udc.pashop.backend.rest.dtos.ProjectConversor.toProjectDto;
...
import es.udc.pashop.backend.rest.dtos.ProjectDto;
