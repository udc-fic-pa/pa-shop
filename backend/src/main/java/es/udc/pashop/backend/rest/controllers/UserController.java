...
import static es.udc.pashop.backend.rest.dtos.UserConversor.toAuthenticatedUserDto;
import static es.udc.pashop.backend.rest.dtos.UserConversor.toUser;
import static es.udc.pashop.backend.rest.dtos.UserConversor.toUserDto;
